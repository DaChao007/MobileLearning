...
import com.example.tiger.mobilelearning.personter.UnBindPresenter;
...
public class PUnBoundImpl implements UnBindPresenter,Observer<UnBind> {

    private RetrofitInterfaceImpl interfaceimpl;
    private UnBoundView baseView;
    private String token;

    public PUnBoundImpl(UnBoundView view, String token) {
    ...
    public void getSuccess(Map<String, String> map) {
        interfaceimpl.requestPostUnBound(this,token,map);
    }
    ...
    @Override
    public void onNext(@NonNull UnBind body) {
