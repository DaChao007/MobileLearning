...
public class PProgressQueryImpl implements SubmitExamPresenter,Observer<ProgressQueryBean> {

    private RetrofitInterfaceImpl interfaceimpl;
    private ProgressQueryView baseView;
    private String token;

    public PProgressQueryImpl(ProgressQueryView view, String token) {
    ...
    public void getSuccess(Map<String, Object> map) {
        interfaceimpl.requestProgressQuery(this,token,map);
    }
    ...
    @Override
    public void onNext(@NonNull ProgressQueryBean progressQueryBean) {
        baseView.OnSucceed(progressQueryBean);
    }
