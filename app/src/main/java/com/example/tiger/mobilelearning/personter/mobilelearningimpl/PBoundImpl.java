...
public class PBoundImpl implements BaseMapPresenter,Observer<BoundBean> {

    private RetrofitInterfaceImpl interfaceimpl;
    private BoundView baseView;
    private String token;

    public PBoundImpl(BoundView view, String token) {
    ...
    public void getSuccess(Map<String, String> map) {
        interfaceimpl.requestPostBoundOk(this,token,map);
    }
    ...
    @Override
    public void onNext(@NonNull BoundBean boundBean) {
        baseView .OnSucceed(boundBean);
    }
