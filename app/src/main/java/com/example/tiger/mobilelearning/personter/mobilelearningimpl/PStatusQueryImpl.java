...
public class PStatusQueryImpl implements SubmitExamPresenter,Observer<StatusQueryBean> {

    private RetrofitInterfaceImpl interfaceimpl;
    private StatusQueryView baseView;
    private String token;

    public PStatusQueryImpl(StatusQueryView view, String token) {
    ...
    public void getSuccess(Map<String,Object> map) {
        interfaceimpl.requestStatusQuery(this,token,map);
    }
    ...
    @Override
    public void onNext(@NonNull StatusQueryBean statusQueryBean) {
        baseView.OnSucceed(statusQueryBean);
    }
