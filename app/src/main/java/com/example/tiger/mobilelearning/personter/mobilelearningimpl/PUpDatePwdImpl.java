...
public class PUpDatePwdImpl implements SubmitExamPresenter,Observer<UpDatePwdBean> {

    private RetrofitInterfaceImpl interfaceimpl;
    private UpDatePwdView baseView;
    private String token;

    public PUpDatePwdImpl(UpDatePwdView view, String token) {
    ...
    public void getSuccess(Map<String,Object> map) {
        interfaceimpl.requestUpdatePwd(this,token,map);
    }
    ...
    @Override
    public void onNext(@NonNull UpDatePwdBean bean) {
